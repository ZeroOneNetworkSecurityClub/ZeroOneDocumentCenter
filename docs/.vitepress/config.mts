...
export default defineConfig({
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright:
        "Build with ❤️ © 2025 <a href='https://www.websec.org.cn/' target='_blank'>零壹网络安全社团</a>",
    },
  ...
  return [
    {
      text: "零壹网络安全社团制度文件",
      items: [
        { text: "零壹网络安全社团章程", link: "/public/零壹网络安全社团章程" },
        {
          text: "零壹网络安全社团业务范围",
          link: "/public/零壹网络安全社团业务范围",
        },
        {
          text: "零壹网络安全社团会员制度",
          link: "/public/零壹网络安全社团会员制度",
        },
        {
          text: "零壹网络安全社团组织机构与产生办法",
          link: "/public/零壹网络安全社团组织机构与产生办法",
        },
        {
          text: "零壹网络安全社团财务管理制度",
          link: "/public/零壹网络安全社团财务管理制度",
        },
        {
          text: "零壹网络安全社团章程修改程序",
          link: "/public/零壹网络安全社团章程修改程序",
        },
        {
          text: "零壹网络安全社团终止程序及终止后的财产处理",
          link: "/public/零壹网络安全社团终止程序及终止后的财产处理",
        },
        {
          text: "零壹网络安全社团网络安全技术培训纲要",
          link: "/public/零壹网络安全社团网络安全技术培训纲要",
        },
      ],
    },
    {
      text: "技术部文件公开",
      items: [{ text: "网络安全技术培训纲要", link: "/technology/WEB方向" }],
    },
  ];
}
